...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.openResourcesFolder = QtWidgets.QPushButton(Dialog)
        self.openResourcesFolder.setObjectName("openResourcesFolder")
        self.horizontalLayout_2.addWidget(self.openResourcesFolder)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.openResourcesFolder.setText(_translate("Dialog", "Find resources folder"))
